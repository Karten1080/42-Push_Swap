...
📏 Règles
    ...
    Au début, la pile a contient une quantité aléatoire de nombres (positifs et/ou négatifs) sans doublons
    La pile b est vide
    Le but est de trier les nombres de la pile a dans l'ordre croissant
    Vous disposez d'un ensemble limité d'opérations
